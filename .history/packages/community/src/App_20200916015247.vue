                            ...
                            <v-row>
                                <v-col cols="12">
                                    <v-form ref="form" v-model="valid" lazy-validation>
                                        ...
                                        <v-file-input accept="image/*" v-model="files" color="black" counter label="Images" multiple placeholder="Upload Pictures" prepend-icon="mdi-paperclip" outlined :show-size="1000">
                                    ...
                                    <template>
                                        <v-card class="mx-auto" max-width="400">
                                            ...
                                            <v-card-actions>
                                                ...
                                                <v-btn v-if="report.resolved" color="orange" @click="goto(report.resolvedLink)" text>Details</v-btn>
